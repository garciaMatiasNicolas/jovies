...
class Card {
    constructor (id, nombre, imagen, descripcion, boton, ruta){
        this.id = id;
        this.nombre = nombre;
        this.imagen = imagen;
...
const card1 = new Card ("burguer", "Nueva Fat Lovie!", "./img/fondo1.png", "Llevando el combo de la nueva fat lovie, podes llevarte un combo fat joe con un 50% OFF!", "Quiero mi combo!", "./secciones/hamburguesas.html");
cards.push(card1);
const card2 = new Card ("sucursales", "Conoce todas nuestras sucursales!", "./img/sucursales.jpg", "En jovies, siempre buscamos estar cerca tuyo, conoce nuestras sucursales!", "Ver sucursales", "#locales");
cards.push(card2);
...
cards.push(card3);
const card4 = new Card ("pollo", "Pedi nuestros buckets de Pollo", "./img/poio.jpg", "En jovies, tenemos el mejor pollo rebozado, para que lo disfrutes vos!", "Pedir mi Bucket", "./secciones/pollos.html");
cards.push(card4);
...
cards.push(card5);
const card6 = new Card ("arma", "Arma la tuya!", "./img/jovie.jpg", "¿Ninguna de nuestras opciones te convencio? No te preocupes, tenemos la solucion. Arma tu Jovie como vos la desees! ", "Quiero mi Jovie", "./secciones/hamburguesas.html");
cards.push(card6);
...
for (let element of cards){
    ...
    <div class="col-6 d-flex justify-content-center p-0 w-100 mt-5">
        ...
        <div class="card-body">
            ...
            <a href="${element.ruta}" class="btn btnColor text-white">${element.boton}</a>
        </div>
        </div>
    </div>
    `
